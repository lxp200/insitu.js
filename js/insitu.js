...
function listenToTrig() {
    document.addEventListener('click', function(e) {
        if (e.target.hasAttribute('data-insitu-src')) {
            ...
            document.getElementById('insitu-art').style.display = "none";  // force safari redraw
            document.getElementById('insitu-art').offsetHeight;            // force safari redraw
            document.getElementById('insitu-art').style.display = "block"; // force safari redraw
